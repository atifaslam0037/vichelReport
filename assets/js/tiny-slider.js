var tns = function () {
    ...
    var $i = function (H) {
        H = Li({
            ...
            controlsText: ['<i class="fa-solid fa-solid fa-chevron-left"></i>', '<i class="fa-solid fa-solid fa-chevron-right"></i>'],
            controlsContainer: !1,
            prevButton: !1,
            nextButton: !1,
            nav: !0,
        ...
        function bn() {
            ...
            oe && (xe || we && Ce || (T.insertAdjacentHTML(on(H.controlsPosition), '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button class="prev-button" type="button" data-controls="prev" tabindex="-1" aria-controls="' + Yt + '">' + pt[0] + '</button><button class="next-button" type="button" data-controls="next" tabindex="-1" aria-controls="' + Yt + '">' + pt[1] + "</button></div>"), xe = T.querySelector(".tns-controls")), we && Ce || (we = xe.children[0], Ce = xe.children[1]), H.controlsContainer && ji(xe, {
