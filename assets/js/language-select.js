...
(function() {
	var LanguagePicker = function(element) {
		...
		this.svgPath = '<svg width="10" height="7" viewBox="0 0 10 7" class="svg_control" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 1.5L5 5.5L9 1.5" stroke="#1C1C1C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>';
	...
	function initButtonPicker(picker) { // create the button element -> picker trigger
		...
		var button = '<div class="language-picker__button'+customClasses+'" aria-label="'+picker.select.value+' '+picker.element.getElementsByTagName('label')[0].innerText+'" aria-expanded="false" aria-contols="'+picker.pickerId+'-dropdown">';
